...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Policy Create</h3>                    
            </div>                
        </div><!-- /.col-lg-12 -->
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="text" name="inception_date_from" class="datepicker form-control" placeholder="From" readonly="true" style="cursor: pointer;background-color: rgba(255, 255, 255, 0.15);">                                            
                                                @if($errors->has('inception_date_from'))
                                                <p class="help-block">{{ $errors->first('inception_date_from') }}</p>
                                                @endif
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="text" name="inception_date_to" class="datepicker form-control" placeholder="To" readonly="true" style="cursor: pointer;background-color: rgba(255, 255, 255, 0.15);">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="act_of_nature" value="1" checked=""> Yes
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="act_of_nature" value="0"> No
                                            </label>
                                        </div>
                                        <div class="form-group">
